...
typedef enum CHIP_IOCON_PIO {
	...
	IOCON_PIO0_3 = (0x0C0 >> 2),	//(0x02C >> 2), correct is (0xC0 >> 2) WPI Wecan Chen 2017.02.17 
	IOCON_PIO0_4 = (0x030 >> 2),
	IOCON_PIO0_5 = (0x034 >> 2),
	IOCON_PIO0_6 = (0x0C4 >> 2), 	//(0x04C >> 2), correct is (0xC4 >> 2) WPI Wecan Chen 2017.02.17
	IOCON_PIO0_7 = (0x0C8 >> 2),	//(0x050 >> 2), correct is (0xC8 >> 2) WPI Wecan Chen 2017.02.17
	...
	IOCON_PIO1_8 = (0x018 >> 2),	//(0x014 >> 2), correct is (0x18 >> 2) WPI Wecan Chen 2017.02.17
