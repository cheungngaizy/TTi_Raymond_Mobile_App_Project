...
public class BTsimple extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_btsimple);
        ...
        mReturnBtn = (Button)findViewById(R.id.mButton_Return);
            ...
            public void handleMessage(android.os.Message msg){
                ...
                if(msg.what == CONNECTING_STATUS){
                    if(msg.arg1 == 1)
                        ...
                        mBluetoothStatus.setText("ReConnecting");
